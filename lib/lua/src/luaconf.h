...
/*
** Some embedded/newlib environments (and some C++ configurations) do support
** 'long long' but do not provide the C99 limit macros in <limits.h>.
** GCC/Clang still define compiler built-ins like __LONG_LONG_MAX__.
*/
#ifndef LLONG_MAX
